  ...
  <div>
    ...
    >
      <el-tab-pane label="基本信息">
        <el-form label-position=" left" label-width="80px" :model="GetData">
          <el-form-item label="名称">
            <el-input v-model="GetData.goods_name"></el-input>
          </el-form-item>
          <el-form-item label="价格">
            <el-input v-model="GetData.goods_price"></el-input>
          </el-form-item>
          <el-form-item label="重量">
            <el-input v-model="GetData.goods_weight"></el-input>
          </el-form-item>
          <el-form-item label="数量">
            <el-input v-model="GetData.goods_number"></el-input>
          </el-form-item>
      ...
      <el-tab-pane label="商品内容">
        <quillEditor class="quill" v-model="GetData.goods_introduce"> </quillEditor>
        <el-button type="success" plain @click="edit_upload">修改按钮</el-button>
      </el-tab-pane>
    </el-tabs>
  </div>
</template>
...
export default {
    ...
    edit_upload(){
        this.http({
          ...
          if(meta.status ===200){
            ...
            this.$message({message:'修改商品成' ,type:'success'})
          }else{
  ...
  mounted() {
    this.http({
      ...
      this.GetData=back.data.data
      console.log(this.GetData);
      this.goods_cat = this.GetData.goods_cat.split(',')
      this.goods_cat=this.goods_cat.map(Number)
      console.log(this.goods_cat)
    });
    this.http({
      url: "categories",
